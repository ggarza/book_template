...
\definecolor{color1}{RGB}{0,145,255}
\definecolor{color2}{RGB}{245,0,0} %
...
\fancypagestyle{chapterheader}{%
  \fancyhead[R]{\ifthenelse{\isodd{\value{page}}}{\thepage}{}}
  \fancyhead[L]{\ifthenelse{\isodd{\value{page}}}{}{\hspace{-0.5em}\thepage}}
}
...
{\color{color1}\contentslabel[\Large\thecontentslabel]{1.00cm}\color{color1}} % Chapter number
{\color{color1}}
{\color{color1}\Large\;\titlerule*[.5pc]{.}\;\thecontentspage} % Page number
...
\titleformat{\chapter} %{<command>}[<shape>]
  ...
  {\color{color1}{\chaptertitlename~\thechapter}} %{<label>}
  {8pt} %{<sep>}
  {\thispagestyle{chapterheader}} %{<before-code>}
  [] %{<after-code>}
...
\titleformat{\subparagraph} %{<command>}[<shape>]
  {\sffamily\LARGE\bfseries} %{<format>}
  {\color{color1}{\thesection}} %{<label>}
  {8pt} %{<sep>}
  {} %{<before-code>}
...
% minimal space required in the bottom margin not to move the title is set
...
% default first level lists with bold styling
\setlist[enumerate,1]{
...
% default second level lists with bold styling
\setlist[enumerate,2]{
  label=\textbf{\alph*.},
  ref=\textbf{\alph*.},
  beginpenalty=2000, midpenalty=-1000, endpenalty=-1000,
  topsep={0pt plus 0pt minus 0pt},
  itemsep={0pt plus 1pt minus 2pt},
  wide, leftmargin=\parindent,
  labelwidth=!, labelindent=0pt
}


% first level list with second level style
...
% inline list with second level list style
...
\renewcommand{\qedsymbol}{\rule{5pt}{5pt}}% Optional qed square
...
spaceabove=0pt,
spacebelow=0pt,
  headfont=\sffamily\bfseries\color{color1},
  notefont=\sffamily\bfseries,
  notebraces={---~}{},
  bodyfont=\normalfont,
  postheadspace=0.5em,
...
\declaretheorem[name=Theorem, style=examplestyle, numbered=yes,
    parent=chapter]{theorem}
\declaretheorem[name=Definition, style=examplestyle, numbered=yes,
    parent=chapter]{definition}
...
\declaretheorem[name=Remark, style=examplestyle, numbered=yes,
    parent=chapter]{remark}
...
\NewEnviron{objectives}[1]{%
  \marginpar{%
    \vspace{-0.1em}
  \noindent{\sffamily\textbf{\Large Objectives}}\\[2pt]
#1
\begin{itemize}[nosep,leftmargin=10.0pt]
    \BODY
\end{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Marginnotes and Caption Configuration
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\DeclareCaptionStyle{marginfigure}{font=footnotesize,labelfont={bf,sf}}
\DeclareCaptionStyle{margintable}{font=footnotesize,labelfont={bf,sf}}
\DeclareCaptionStyle{sidecaption}{labelfont={bf,sf}}
...
\graphicspath{{graphics/}} % Specifies where graphics are stored
