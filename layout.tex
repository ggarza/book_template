...
\fancypagestyle{chapterheader}{%
  \fancyhead[R]{\ifthenelse{\isodd{\value{page}}}{\large\thepage}{}}
  \fancyhead[L]{\ifthenelse{\isodd{\value{page}}}{}{\large\thepage}}
}
...
{\color{color1}\contentslabel[\Large\thecontentslabel]{1.00cm}\color{maincolor}} % Chapter number
{\color{color1}}
