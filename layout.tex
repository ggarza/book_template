...
\renewcommand{\chaptermark}[1]{\markboth{\normalsize\bfseries\chaptername~\thechapter\vbarr#1}{}} % Chapter text font settings
...
\renewcommand{\qedsymbol}{\color{maincolor}\rotatebox[origin=c]{45}{\rule{4pt}{4pt}}}% Optional qed square
